...
class CardRegistrationPage extends StatelessWidget {
  CardRegistrationPage({super.key, required this.country});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          if (cardsController.wasPaymentMade.value == true &&
              cardsController.wasCardIssued.value == false)
            TxtInput(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        InkWell(
                          onTap: () => cardsController.takeSelfie('NationalIDs',
                              'front', cardsController.frontIDImageUrl),
                          child: Obx(
                            () => CircleAvatar(
                              radius: 60,
                              backgroundColor: Colors.deepPurple,
                              child: cardsController.frontIDImageUrl.value != ''
                                  ? ClipRRect(
                                      borderRadius: BorderRadius.circular(60),
                                      child: CachedNetworkImage(
                    ...
                    Column(
                      children: [
                        ...
                        InkWell(
                          onTap: () => cardsController.takeSelfie('NationalIDs',
                              'back', cardsController.backIDImageUrl),
                          child: Obx(
                            () => CircleAvatar(
                              radius: 60,
                              backgroundColor: Colors.deepPurple,
                              child: cardsController.backIDImageUrl.value != ''
                                  ? ClipRRect(
                                      borderRadius: BorderRadius.circular(60),
                                      child: CachedNetworkImage(
                                        imageUrl: cardsController
          ...
          Btn(
            ...
            ontap: () {
              if (cardsController.wasPaymentMade.value == true &&
                  cardsController.wasCardIssued.value == false) {
                cardsController.validatedPostCardRegistrationDetails();
              } else {
                cardsController.validatedCardRegistrationDetails();
              }
            },
            btnName: (cardsController.wasPaymentMade.value == true &&
                    cardsController.wasCardIssued.value == false)
