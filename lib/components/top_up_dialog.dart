...
class TopupDialogBox extends StatefulWidget {
  TopupDialogBox({super.key, required this.width});
  double width;
  @override
  _TopupDialogBoxState createState() => _TopupDialogBoxState();
}

class _TopupDialogBoxState extends State<TopupDialogBox> {
